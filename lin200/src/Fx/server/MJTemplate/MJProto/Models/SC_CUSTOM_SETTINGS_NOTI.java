...
import Fx.server.MJTemplate.MJProto.MJAProtoMessage;
import Fx.server.MJTemplate.MJProto.MJEProtoMessages;
import lineage.network.LineageClient;
import lineage.world.object.instance.PcInstance;

public class SC_CUSTOM_SETTINGS_NOTI extends MJAProtoMessage{

	public static SC_CUSTOM_SETTINGS_NOTI newInstance() {
		return new SC_CUSTOM_SETTINGS_NOTI();
	}

	@Override
	public MJEProtoMessages getMessageType() {
		return MJEProtoMessages.SC_CUSTOM_SETTINGS_NOTI;
	}	
	...
	private SC_CUSTOM_SETTINGS_NOTI() {
		mFlags = 0;
	}

	public SC_CUSTOM_SETTINGS_NOTI setFlags(int flags){
		mFlags = flags;
		return this;
	}
	...
	public int getSerializedSize() {
		int size = 0;
		int sequence = 1;
		size += Fx.server.MJTemplate.MJProto.ProtoOutputStream.computeUInt32Size(sequence++, mFlags);
	...
	public void writeTo(Fx.server.MJTemplate.MJProto.ProtoOutputStream output) throws java.io.IOException {
		int sequence = 1;
		output.writeUInt32(sequence++, mFlags);
	}
