...
public final class Lineage {
	...
	static public int go_gr = 1;
	static public int go_wg = 1;
	static public int go_dark = 1;
	...
	static public int go_jungmu = 1;
	static public int go_shadow = 1;
	...
	// 레벨업 아이템
	static public int levelup_support2_target = 60;
	// 팀대전 맵
	...
	// 버프 최대 중첩 시간(초)
	static public int buff_add_max_time = 36000;
	// 트리플 애로우 액션번호
	...
	// 오만의 탑 입장 가능 여부
	static public boolean is_oman_join = true;
	// 오만의 탑 입장 레벨
	static public int oman_min_level;
	// 오만의 탑 입장시 필요 아이템
	static public String oman_join_item;
	// 오만의 탑 입장시 필요 아이템 갯수
	...
	// 기르타스 성지 입장 레벨
	static public int girtas_min_level;
	// 기르타스 성지 입장시 필요 아이템
	...
	// 정령의 무덤 입장 레벨
	static public int jungmu_min_level;
	// 정령의 무덤 입장시 필요 아이템
	...
	// 마법인형 액션 표현
	static public final int[] magicDollAction = { 66, 67, 68, 98, 99 };
	// 헬파이어 이팩트
	...
	// 그림자 신전 입장 레벨
	static public int rmflawk_dungeon_level;
	static public int rmflawk_dungeon_level2;
	static public int rmflawk_dungeon_level3;
	// 기란 감옥 입장 레벨
	...
	static public int darkelf_stat_dice;
	...
	static public int BOW_ATTACK_LOCATIONRANGE = 7; // 활 공격 범위
	...
	static public int f1_tel4 = 0;
	static public int f1_tel5 = 0;
	static public int f1_tel6 = 0;
	static public int f1_tel7 = 0;
	static public int f1_tel8 = 0;
	static public int f1_tel9 = 0;
	static public int f1_tel10 = 0;
	static public int f1_tel11 = 0;
	...
	static public int f2_tel4 = 0;
	static public int f2_tel5 = 0;
	static public int f2_tel6 = 0;
	static public int f2_tel7 = 0;
	static public int f2_tel8 = 0;
	static public int f2_tel9 = 0;
	static public int f2_tel10 = 0;
	static public int f2_tel11 = 0;
...
// 5단계 특수 마법인형
	...
	// 고무 수배자만 입장가능 여부
	static public boolean gomu_wanted = false;
	// 고무 혈맹가입자만 입장가능 여부
	static public boolean gomu_clan = false;
	// 고무 입장 평일시간
	static public List<TeamBattleTime> gomu_dungeon_time_list = new ArrayList<TeamBattleTime>();
	static public String gomu_dungeon_time = "";
	// 고무 입장 주말시간
	static public List<TeamBattleTime> gomu_dungeon_time_list2 = new ArrayList<TeamBattleTime>();
	...
	// 정령의무덤 수배자만 입장가능 여부
	static public boolean jungmu_wanted = false;
	// 정령의무덤 혈맹가입자만 입장가능 여부
	static public boolean jungmu_clan = false;
	// 정령의무덤 입장 평일시간
	static public List<TeamBattleTime> jungmu_dungeon_time_list = new ArrayList<TeamBattleTime>();
	static public String jungmu_dungeon_time = "";
	// 정령의무덤 입장 주말시간
	static public List<TeamBattleTime> jungmu_dungeon_time_list2 = new ArrayList<TeamBattleTime>();
	...
	// 그림자신전 수배자만 입장가능 여부
	static public boolean shadow_wanted = false;
	// 그림자신전 혈맹가입자만 입장가능 여부
	static public boolean shadow_clan = false;
	// 그림자신전 입장 평일시간
	static public List<TeamBattleTime> shadow_dungeon_time_list = new ArrayList<TeamBattleTime>();
	static public String shadow_dungeon_time = "";
	// 그림자신전 입장 주말시간
	...
	// 라스타바드 수배자만 입장가능 여부
	static public boolean lasta_wanted = false;
	// 라스타바드 혈맹가입자만 입장가능 여부
	static public boolean lasta_clan = false;
	// 라스타바드 입장 평일시간
	static public List<TeamBattleTime> lasta_dungeon_time_list = new ArrayList<TeamBattleTime>();
	static public String lasta_dungeon_time = "";
	// 라스타바드 입장 주말시간
	static public List<TeamBattleTime> lasta_dungeon_time_list2 = new ArrayList<TeamBattleTime>();
	...
	// 칠흑던전 수배자만 입장가능 여부
	static public boolean dark_wanted = false;
	// 칠흑던전 혈맹가입자만 입장가능 여부
	static public boolean dark_clan = false;
	// 칠흑던전 입장 평일시간
	static public List<TeamBattleTime> dark_dungeon_time_list = new ArrayList<TeamBattleTime>();
	static public String dark_dungeon_time = "";
	// 칠흑신전 입장 주말시간
	static public List<TeamBattleTime> dark_dungeon_time_list2 = new ArrayList<TeamBattleTime>();
	...
	// 칠흑던전3 수배자만 입장가능 여부
	static public boolean dark3_wanted = false;
	// 칠흑던전3 혈맹가입자만 입장가능 여부
	static public boolean dark3_clan = false;
	// 칠흑던전3 입장 평일시간
	static public List<TeamBattleTime> dark3_dungeon_time_list = new ArrayList<TeamBattleTime>();
	static public String dark3_dungeon_time = "";
	// 칠흑신전3 입장 주말시간
	static public List<TeamBattleTime> dark3_dungeon_time_list2 = new ArrayList<TeamBattleTime>();
	static public String dark3_dungeon_time2 = "";
	// 칠흑던전3 진행 시간(초)
	static public int dark3_play_time = 600;

	// 칠흑던전4 입장 레벨
	static public int dark4_level = 1;
	// 칠흑던전4 수배자만 입장가능 여부
	static public boolean dark4_wanted = false;
	// 칠흑던전4 혈맹가입자만 입장가능 여부
	static public boolean dark4_clan = false;
	// 칠흑던전4 입장 평일시간
	static public List<TeamBattleTime> dark4_dungeon_time_list = new ArrayList<TeamBattleTime>();
	static public String dark4_dungeon_time = "";
	// 칠흑신전4 입장 주말시간
	static public List<TeamBattleTime> dark4_dungeon_time_list2 = new ArrayList<TeamBattleTime>();
	...
	// 고라스 수배자만 입장가능 여부
	static public boolean goras_wanted = false;
	// 고라스 혈맹가입자만 입장가능 여부
	static public boolean goras_clan = false;
	// 고라스 입장 시간
	...
	// 드워프 광산 수배자만 입장가능 여부
	static public boolean dwarf_wanted = false;
	// 드워프 광산 혈맹가입자만 입장가능 여부
	static public boolean dwarf_clan = false;
	// 드워프 광산 입장 시간
 ...
 //방랑상인
	...
	// 악마왕의 영토 입장 시간2
	static public List<TeamBattleTime> devil_dungeon_time_list2 = new ArrayList<TeamBattleTime>();
	...
	static public String auto_bravery_item_name_darkelf;
	...
	public static boolean giran_dungeon_wanted;
	...
	static public void init(boolean reload) {
		...
		try {
			...
			devil_dungeon_time_list2.clear();
			...
			dark_dungeon_time_list.clear();
			dark_dungeon_time_list2.clear();
			dark3_dungeon_time_list.clear();
			dark3_dungeon_time_list2.clear();
			dark4_dungeon_time_list.clear();
			dark4_dungeon_time_list2.clear();
			lasta_dungeon_time_list.clear();
			lasta_dungeon_time_list2.clear();
			gomu_dungeon_time_list.clear();
			gomu_dungeon_time_list2.clear();
			jungmu_dungeon_time_list.clear();
			jungmu_dungeon_time_list2.clear();
			shadow_dungeon_time_list.clear();
			shadow_dungeon_time_list2.clear();
			prison_dungeon_time_list.clear();
			prison_dungeon_time_list2.clear();
			goras_dungeon_time_list.clear();
			dwarf_dungeon_time_list.clear();
			oman1_dungeon_time_list.clear();
			oman1_dungeon_time_list2.clear();
			oman2_dungeon_time_list.clear();
			oman2_dungeon_time_list2.clear();
			oman3_dungeon_time_list.clear();
			oman3_dungeon_time_list2.clear();
			oman4_dungeon_time_list.clear();
			oman4_dungeon_time_list2.clear();
			oman5_dungeon_time_list.clear();
			oman5_dungeon_time_list2.clear();
			oman6_dungeon_time_list.clear();
			oman6_dungeon_time_list2.clear();
			oman7_dungeon_time_list.clear();
			oman7_dungeon_time_list2.clear();
			oman8_dungeon_time_list.clear();
			oman8_dungeon_time_list2.clear();
			oman9_dungeon_time_list.clear();
			oman9_dungeon_time_list2.clear();
			oman10_dungeon_time_list.clear();
			...
			while ((line = lnrr.readLine()) != null) {
				...
				if (pos > 0) {
					...
					if (key.equalsIgnoreCase("royal_spawn"))
					...
					else if (key.equalsIgnoreCase("darkelf_stat_dice"))
						darkelf_stat_dice = Integer.valueOf(value);
					...
					else if (key.equalsIgnoreCase("doll_drogon2"))
						doll_drogon2 = Integer.valueOf(value);
						...
						f1_tel2 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel3"))
						f1_tel3 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel4"))
						f1_tel4 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel5"))
						f1_tel5 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel6"))
						f1_tel6 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel7"))
						f1_tel7 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel8"))
						f1_tel8 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel9"))
						f1_tel9 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel10"))
						f1_tel10 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel11"))
						f1_tel11 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel12"))
						f1_tel12 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f1_tel13"))
						...
						f2_tel2 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel3"))
						f2_tel3 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel4"))
						f2_tel4 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel5"))
						f2_tel5 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel6"))
						f2_tel6 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel7"))
						f2_tel7 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel8"))
						f2_tel8 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel9"))
						f2_tel9 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel10"))
						f2_tel10 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel11"))
						f2_tel11 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel12"))
						f2_tel12 = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("f2_tel13"))
					...
					else if (key.equalsIgnoreCase("is_wjstjf"))
                    ...
                    is_autosell_global = value.equalsIgnoreCase("true");
						...
						go_hell = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("go_dragon"))
						...
						oman_join_item = value;
					else if (key.equalsIgnoreCase("oman_join_item_count"))
						oman_join_item_count = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("ice_join_item"))
						ice_join_item = value;
					else if (key.equalsIgnoreCase("ice_join_item_count"))
					...
					else if (key.equalsIgnoreCase("dark4_dungeon_time2")) {
						...
						gomu_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("gomu_clan"))
						gomu_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("gomu_dungeon_time")) {
						gomu_dungeon_time = value;
						...
						jungmu_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("jungmu_clan"))
						jungmu_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("jungmu_dungeon_time")) {
						jungmu_dungeon_time = value;
						...
						shadow_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("shadow_clan"))
						shadow_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("shadow_dungeon_time")) {
						shadow_dungeon_time = value;
						...
						prison_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("prison_clan"))
						prison_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("prison_dungeon_time")) {
						prison_dungeon_time = value;
						...
						lasta_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("lasta_clan"))
						lasta_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("lasta_dungeon_time")) {
						lasta_dungeon_time = value;
						...
						goras_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("goras_clan"))
						goras_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("goras_dungeon_time")) {
						goras_dungeon_time = value;
						...
						dwarf_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dwarf_clan"))
						dwarf_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dwarf_dungeon_time")) {
						dwarf_dungeon_time = value;
						...
						dark_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dark_clan"))
						dark_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dark_dungeon_time")) {
						dark_dungeon_time = value;
						...
						dark3_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dark3_clan"))
						dark3_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dark3_dungeon_time")) {
						dark3_dungeon_time = value;
						teamBattleTime(dark3_dungeon_time_list, value);
					} else if (key.equalsIgnoreCase("dark3_play_time"))
						dark3_play_time = Integer.valueOf(value);

					else if (key.equalsIgnoreCase("dark4_level"))
						dark4_level = Integer.valueOf(value);
					else if (key.equalsIgnoreCase("dark4_wanted"))
						dark4_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dark4_clan"))
						dark4_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("dark4_dungeon_time")) {
						dark4_dungeon_time = value;
						...
						oman1_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman1_clan"))
						oman1_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman1_dungeon_time")) {
						oman1_dungeon_time = value;
						...
						oman2_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman2_clan"))
						oman2_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman2_dungeon_time")) {
						oman2_dungeon_time = value;
						...
						oman3_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman3_clan"))
						oman3_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman3_dungeon_time")) {
						oman3_dungeon_time = value;
						...
						oman4_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman4_clan"))
						oman4_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman4_dungeon_time")) {
						oman4_dungeon_time = value;
						...
						oman5_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman5_clan"))
						oman5_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman5_dungeon_time")) {
						oman5_dungeon_time = value;
						...
						oman6_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman6_clan"))
						oman6_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman6_dungeon_time")) {
						oman6_dungeon_time = value;
						...
						oman7_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman7_clan"))
						oman7_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman7_dungeon_time")) {
						oman7_dungeon_time = value;
						...
						oman8_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman8_clan"))
						oman8_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman8_dungeon_time")) {
						oman8_dungeon_time = value;
						...
						oman9_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman9_clan"))
						oman9_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman9_dungeon_time")) {
						oman9_dungeon_time = value;
						...
						oman10_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman10_clan"))
						oman10_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman10_dungeon_time")) {
						...
						oman0_wanted = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman0_clan"))
						oman0_clan = value.equalsIgnoreCase("true");
					else if (key.equalsIgnoreCase("oman0_dungeon_time")) {
					...
					else if (key.equalsIgnoreCase("auto_bravery_item_name_darkelf"))
						auto_bravery_item_name_darkelf = value;
