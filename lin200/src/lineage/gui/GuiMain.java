...
public final class GuiMain {
	...
	static public void open() {
		...
		MenuItem reload_menu_37 = new MenuItem(reload_menu, SWT.NONE);
		reload_menu_37.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				TalkScrollDatabase.reload();
			}
		});
		reload_menu_37.setText("talk_scroll 테이블 리로드");
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					Runtime.getRuntime().exec(
							"C:/WINDOWS/system32/notepad.exe " + System.getProperty("user.dir") + "/lineage.conf");
				} catch (Exception e2) {
				}
			}
		});
		...
		lineageBalanceConf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					Runtime.getRuntime().exec("C:/WINDOWS/system32/notepad.exe " + System.getProperty("user.dir")
							+ "/lineage_balance.conf");
				} catch (Exception e2) {
				}
			}
		});
		...
		socketConf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					Runtime.getRuntime()
							.exec("C:/WINDOWS/system32/notepad.exe " + System.getProperty("user.dir") + "/socket.conf");
				} catch (Exception e2) {
				}
			}
		});
		...
		mySqlConf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					Runtime.getRuntime()
							.exec("C:/WINDOWS/system32/notepad.exe " + System.getProperty("user.dir") + "/mysql.conf");
				} catch (Exception e2) {
				}
			}
		});
		...
		noticeTxt.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					Runtime.getRuntime()
							.exec("C:/WINDOWS/system32/notepad.exe " + System.getProperty("user.dir") + "/notice.txt");
				} catch (Exception e2) {
				}
			}
		});
