...
public class S_ObjectAdd extends S_Inventory {
	...
	public void toClone(object o, object oo) {
		...
		boolean isHpbar = 
				...
				(oo.getGm() != 0 && o instanceof MonsterInstance) || 
				(oo.getGm() != 0 && o instanceof NpcInstance) || 
				(o.isHpbar() && o.getObjectId() == oo.getObjectId()) || 
				(oo.getGm() != 0 && o instanceof PcInstance);
		byte[] msg = null;
		...
		if (o instanceof ItemInstance) {		
			...
			// 축저주 구분
			if (item.isDefinite()) {
				//sb.append(item.getBless() == 0 ? "축복받은" : (item.getBless() == 1 ? "" : "저주받은"));
				// 인첸트 레벨 표현
