	...
	static public boolean isTeleportZone(object o, boolean packet, boolean ment){
		...
		case 101:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 1층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 1층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 102:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 2층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 2층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 103:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 3층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 3층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 104:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 4층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 4층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 105:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 5층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 5층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 106:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 6층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 6층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 107:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 7층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 7층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 108:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 8층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 8층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 109:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 9층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 9층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;
		case 110:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 10층 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 10층 이동 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적")
						|| item.getItem().getName().equalsIgnoreCase("순간이동 지배 반지"))
					return true;
			}
			break;
		case 200:
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("오만의 탑 정상 이동 부적")|| item.getItem().getName().equalsIgnoreCase("오만의 탑 정상 지배 부적") || item.getItem().getName().equalsIgnoreCase("오만의 탑 환상의 지배 부적"))
					return true;
			}
			break;			
...
//		        case 781: // 순간이동 지배 반지/테베 던전	  
			for (ItemInstance item : o.getInventory().getList()) {
				if (item.getItem().getName().equalsIgnoreCase("순간이동 지배 반지") || item.getItem().getName().equalsIgnoreCase("순간이동 조종 반지"))
					return true;
			}
			break;
                }
