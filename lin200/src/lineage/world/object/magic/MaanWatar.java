...
public class MaanWatar extends Magic {
	...
	public void toBuffStart(object o) {
		...
		// [추가] 버프 시작 시 92번 아이콘 출력
		if (o instanceof PcInstance) {
			SC_BUFFICON_NOTI.on((PcInstance)o, 92, this.getTime(), SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
	}
	...
	public void toBuffEnd(object o) {
		...
		if (o instanceof PcInstance) {
			SC_BUFFICON_NOTI.on((PcInstance)o, 92, 0, SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
	}
