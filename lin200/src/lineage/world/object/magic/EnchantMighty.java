...
public class EnchantMighty extends Magic {
	...
	public void toBuffUpdate(object o) {
		// [수정] 구형 패킷(S_BuffStr) 삭제 후 신규 아이콘(5번) 적용
		if (o instanceof PcInstance) {
			PcInstance pc = (PcInstance) o;
			SC_BUFFICON_NOTI.on(pc, 5, this.getTime(), SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
	}
	...
	public void toBuffEnd(object o) {
		...
		// [추가] 종료 시 아이콘 즉시 삭제 (5번)
		if (o instanceof PcInstance) {
			SC_BUFFICON_NOTI.on((PcInstance)o, 5, 0, SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
	}
