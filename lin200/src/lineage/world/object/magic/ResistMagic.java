...
public class ResistMagic extends Magic {
	...
	public void toBuffUpdate(object o) {
		...
		if (o instanceof PcInstance) {
			...
			SC_BUFFICON_NOTI.on(pc, 9, this.getTime(), SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
	}
	...
	public void toBuffEnd(object o) {
		...
		// 종료 시 아이콘 즉시 삭제
		if (o instanceof PcInstance) {
			SC_BUFFICON_NOTI.on((PcInstance)o, 9, 0, SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
