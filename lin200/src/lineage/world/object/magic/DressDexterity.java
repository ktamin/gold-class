...
public class DressDexterity extends Magic {
	...
	public void toBuffUpdate(object o){
		// 버프 갱신 및 아이콘 유지 (44번)
		// 기존 S_BuffDex 패킷 제거 후 신규 규격 사용
		if (o instanceof PcInstance) {
			PcInstance pc = (PcInstance) o;
			SC_BUFFICON_NOTI.on(pc, 44, this.getTime(), SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
	}
	...
	public void toBuffEnd(object o){
		...
		// 종료 시 아이콘 즉시 삭제
		if (o instanceof PcInstance) {
			SC_BUFFICON_NOTI.on((PcInstance)o, 44, 0, SC_BUFFICON_NOTI.REMAINING_TYPE_SECONDS);
		}
		
		// 종료 멘트 중복 방지 (주석 처리)
		// if(o instanceof Character){
		// 	Character cha = (Character) o;
		// 	ChattingController.toChatting(cha, "\\fY드레스 덱스터리티가 종료되었습니다.", Lineage.CHATTING_MODE_MESSAGE);
		// }	
	}
