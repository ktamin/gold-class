	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		...
		if (action.equalsIgnoreCase("a")) {
			for (ShopInstance si : NpcSpawnlistDatabase.getShopList()) {
				...
				if (si.getNpc().getName().contains("달러 상점(무기)")){
		...
		if (action.equalsIgnoreCase("b")) {
			for (ShopInstance si : NpcSpawnlistDatabase.getShopList()) {
				...
				if (si.getNpc().getName().contains("달러 상점(방어구)")){
					si.toTalk((PcInstance) pc, null);
		...
		if (action.equalsIgnoreCase("c")) {
			for (ShopInstance si : NpcSpawnlistDatabase.getShopList()) {
				...
				if (si.getNpc().getName().contains("달러 상점(악세)")){
					si.toTalk((PcInstance) pc, null);
		...
		if (action.equalsIgnoreCase("d")) {
			for (ShopInstance si : NpcSpawnlistDatabase.getShopList()) {
				...
				if (si.getNpc().getName().contains("달러 상점(마법)")){
					si.toTalk((PcInstance) pc, null);
		...
		if (action.equalsIgnoreCase("e")) {
			for (ShopInstance si : NpcSpawnlistDatabase.getShopList()) {
				...
				if (si.getNpc().getName().contains("달러 상점(잡화)")){
					si.toTalk((PcInstance) pc, null);
