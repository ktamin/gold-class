...
public class 전설의무기 extends object {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "plcre"));
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		if (pc.getInventory() != null) {
			...
			if (action.equalsIgnoreCase("1")) {
				...
				createList.add(new CreateItem("퓨어 엘릭서", false, 1, false, 0, 50));
				checkItem(pc, createList, itemList);
				
				createItem(pc, createList, createList2, itemList, "엘릭서 (STR)", 1, 0, 1);
				...
				createItem(pc, createList, createList2, itemList, "엘릭서 (CON)", 1, 0, 1);
				...
				createItem(pc, createList, createList2, itemList, "엘릭서 (DEX)", 1, 0, 1);
				...
				createItem(pc, createList, createList2, itemList, "엘릭서 (INT)", 1, 0, 1);
				...
				createItem(pc, createList, createList2, itemList, "엘릭서 (WIS)", 1, 0, 1);
				...
				createItem(pc, createList, createList2, itemList, "엘릭서 (CHA)", 1, 0, 1);
