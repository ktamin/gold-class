...
public class 마물암석제작사 extends object {
    ...
    public void toTalk(PcInstance pc, ClientBasePacket cbp) {
        pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "monsterarmorcreate"));
    }
    ...
    public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
        if (pc.getInventory() != null) {
            ...
            if (action.equalsIgnoreCase("고대 마물의 장갑")) {
                ...
                createItem(pc, createList, itemList, "고대 마물의 장갑", 1, 0, 1, 100);
                ...
                createItem(pc, createList, itemList, "고대 마물의 부츠", 1, 0, 1, 100);
                ...
                createItem(pc, createList, itemList, "고대 마물의 망토", 1, 0, 1, 100);
                ...
                createItem(pc, createList, itemList, "고대 암석의 장갑", 1, 0, 1, 100);
                ...
                createItem(pc, createList, itemList, "고대 암석의 부츠", 1, 0, 1, 100);
                ...
                createItem(pc, createList, itemList, "고대 암석의 망토", 1, 0, 1, 100);
