...
public class 테베합성사 extends object {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "tebeacc"));
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		if (pc.getInventory() != null) {
			...
			if (action.equalsIgnoreCase("균열의 핵")) {				
				createList.add(new CreateItem("균열의 파편", false, 100, false, 0, 100));	
				createList.add(new CreateItem("아데나", false, 1, false, 0, 500000));
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "균열의 핵", 1, 0, 1);
				
			} else if (action.equalsIgnoreCase("잠긴 하급 상자")) {					
				createList.add(new CreateItem("하급 테베오시리스의 상자조각(상)", false, 1, false, 0, 1));
				createList.add(new CreateItem("하급 테베오시리스의 상자조각(하)", false, 1, false, 0, 1));				
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "잠긴 하급 테베오시리스의 상자", 1, 0, 1);
					
			} else if (action.equalsIgnoreCase("잠긴 상급 상자")) {					
				createList.add(new CreateItem("상급 테베오시리스의 상자조각(상)", false, 1, false, 0, 1));
				createList.add(new CreateItem("상급 테베오시리스의 상자조각(하)", false, 1, false, 0, 1));				
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "잠긴 상급 테베오시리스의 상자", 1, 0, 1);
				
			} else if (action.equalsIgnoreCase("열린 하급 상자")) {					
				createList.add(new CreateItem("잠긴 하급 테베오시리스의 상자", false, 1, false, 0, 1));
				createList.add(new CreateItem("균열의 핵", false, 1, false, 0, 1));				
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "열린 하급 테베오시리스의 상자", 1, 0, 1);
				
			} else if (action.equalsIgnoreCase("열린 상급 상자")) {					
				createList.add(new CreateItem("잠긴 상급 테베오시리스의 상자", false, 1, false, 0, 1));
				createList.add(new CreateItem("균열의 핵", false, 1, false, 0, 1));			
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "열린 상급 테베오시리스의 상자", 1, 0, 1);
