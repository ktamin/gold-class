...
public class 전설의제작사 extends object {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "legendCreate"));
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		if (pc.getInventory() != null) {
			...
			List<ItemInstance> itemList = new ArrayList<ItemInstance>();
             ...
             if (action.equalsIgnoreCase("마법인형: 기사")) {
	...
	//			createList.add(new CreateItem("마법인형: 발라카스", false, 1, false, 0, 1));
				...
				createItem(pc, createList, createList2, itemList, "마법인형: 기사", 1, 0, 1);
      
            } else if (action.equalsIgnoreCase("마법인형: 군주")) {
		...
		//		createList.add(new CreateItem("마법인형: 안타라스", false, 1, false, 0, 1));
				...
				createItem(pc, createList, createList2, itemList, "마법인형: 군주", 1, 0, 1);	
            
            } else if (action.equalsIgnoreCase("마법인형: 마법사")) {
		...
		//		createList.add(new CreateItem("마법인형: 파푸리온", false, 1, false, 0, 1));
				...
				createItem(pc, createList, createList2, itemList, "마법인형: 마법사", 1, 0, 1);	
				
             } else if (action.equalsIgnoreCase("마법인형: 요정")) {
		...
		//		createList.add(new CreateItem("마법인형: 린드비오르", false, 1, false, 0, 1));
				...
				createItem(pc, createList, createList2, itemList, "마법인형: 요정", 1, 0, 1);
             }
		}
