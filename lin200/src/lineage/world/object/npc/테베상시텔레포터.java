...
public class 테베상시텔레포터 extends object {
    ...
    public void toTalk(PcInstance pc, ClientBasePacket cbp) {
        ...
        pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "tebe24tel", null, list));
    }

    @Override
    public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
        if (!action.equalsIgnoreCase("tebe24_teleport"))
            return;
