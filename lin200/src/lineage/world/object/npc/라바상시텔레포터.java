...
public class 라바상시텔레포터 extends object {
    ...
    public void toTalk(PcInstance pc, ClientBasePacket cbp) {
        ...
        list.add(String.format("입장재료 : 아데나 %,d 개", Lineage.go_lasta));

        pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "lasta24tel", null, list));
    }

    @Override
    public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
        if (!action.equalsIgnoreCase("lasta24_teleport"))
            return;
        ...
        // 1) 레벨 체크
        if (pc.getLevel() < Lineage.lasta_level) {
