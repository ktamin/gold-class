...
public class 보석세공사 extends object {
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		if (pc.getInventory() != null) {
			...
			if (action.equalsIgnoreCase("고급 루비")) {
				...
				createList.add(new CreateItem("루비", false, 1, false, 0, 25));
				...
				createList.add(new CreateItem("사파이어", false, 1, false, 0, 25));
				checkItem(pc, createList, itemList);
				...
				createList.add(new CreateItem("에메랄드", false, 1, false, 0, 25));
				checkItem(pc, createList, itemList);
				...
				createList.add(new CreateItem("다이아몬드", false, 1, false, 0, 25));
				checkItem(pc, createList, itemList);
				...
				createList.add(new CreateItem("고급 루비", false, 1, false, 0, 10));
				checkItem(pc, createList, itemList);
				...
				createList.add(new CreateItem("고급 사파이어", false, 1, false, 0, 10));
				checkItem(pc, createList, itemList);
				...
				createList.add(new CreateItem("고급 에메랄드", false, 1, false, 0, 10));
				checkItem(pc, createList, itemList);
				...
				createList.add(new CreateItem("고급 다이아몬드", false, 1, false, 0, 10));
				checkItem(pc, createList, itemList);
