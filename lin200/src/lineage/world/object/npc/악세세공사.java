...
public class 악세세공사 extends object {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "jewelCreate1"));
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		if (pc.getInventory() != null) {
            ...
            if (action.equalsIgnoreCase("완력의 목걸이 분해")) {				
				createList.add(new CreateItem("완력의 목걸이", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));
				
			} else if (action.equalsIgnoreCase("지식의 목걸이 분해")) {				
				createList.add(new CreateItem("지식의 목걸이", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));
				
			} else if (action.equalsIgnoreCase("민첩의 목걸이 분해")) {			
				createList.add(new CreateItem("민첩의 목걸이", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);			
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));
				
			} else if (action.equalsIgnoreCase("완력의 반지 분해")) {			
				createList.add(new CreateItem("완력의 반지", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));
				
			} else if (action.equalsIgnoreCase("지식의 반지 분해")) {			
				createList.add(new CreateItem("지식의 반지", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));
			
			} else if (action.equalsIgnoreCase("민첩의 반지 분해")) {			
				createList.add(new CreateItem("민첩의 반지", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));	
				
			} else if (action.equalsIgnoreCase("멸마의 반지 분해")) {				
				createList.add(new CreateItem("멸마의 반지", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));
			...
			} else if (action.equalsIgnoreCase("민첩의 벨트 분해")) {			
				createList.add(new CreateItem("민첩의 벨트", false, 1, true, 0, 1));		
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "신성한 조각", 1, 0, Util.random(10, 20));
