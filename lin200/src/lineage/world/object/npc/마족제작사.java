...
public class 마족제작사 extends object {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "deteacc"));
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		if (pc.getInventory() != null) {
			...
			if (action.equalsIgnoreCase("저주받은 피")) {				
				createList.add(new CreateItem("혈석 파편", false, 1, false, 0, 100));	
				...
				createList.add(new CreateItem("저주받은 피", false, 1, false, 0, 10));
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "악마왕의 이도류", 1, 0, 1);
				
			} else if (action.equalsIgnoreCase("악마왕의 활")) {					
				createList.add(new CreateItem("타락의 악마서 1권", false, 1, false, 0, 1));
				createList.add(new CreateItem("타락의 악마서 2권", false, 1, false, 0, 1));	
				createList.add(new CreateItem("타락의 악마서 3권", false, 1, false, 0, 1));
				createList.add(new CreateItem("타락의 악마서 4권", false, 1, false, 0, 1));
				createList.add(new CreateItem("저주받은 피", false, 1, false, 0, 10));
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "악마왕의 활", 1, 0, 1);
				
			} else if (action.equalsIgnoreCase("악마왕의 지팡이")) {					
				createList.add(new CreateItem("타락의 악마서 1권", false, 1, false, 0, 1));
				createList.add(new CreateItem("타락의 악마서 2권", false, 1, false, 0, 1));	
				createList.add(new CreateItem("타락의 악마서 3권", false, 1, false, 0, 1));
				createList.add(new CreateItem("타락의 악마서 4권", false, 1, false, 0, 1));
				createList.add(new CreateItem("저주받은 피", false, 1, false, 0, 1));
				checkItem(pc, createList, itemList);				
				createItem(pc, createList, createList2, itemList, "악마왕의 지팡이", 1, 0, 1);	
