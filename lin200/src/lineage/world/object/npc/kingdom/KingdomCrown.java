...
//	}
	...
	public void toDamage(Character cha, int dmg, int type, Object... opt) {
		if (cha instanceof PcInstance && cha.getInventory() != null && Util.isDistance(this, cha, 1)) {
			...
			if (cha.isDead() || kingdom == null || cha.isInvis() || cha.getClanId() == 0
				|| cha.getClanName().equalsIgnoreCase(Lineage.teamBattle_A_team) 
				|| cha.getClanName().equalsIgnoreCase(Lineage.teamBattle_B_team) 
	...
	/*		// 성에 혈맹이 지정되있을 경우에만 처리.
			...
			if (Lineage.giran_kingdom_crown_min > 0) {
				int crownTime = Lineage.giran_kingdom_crown_min;
				kingdom.msg_count = Lineage.giran_kingdom_crown_min;
				kingdom.setCrownPickupEnd(System.currentTimeMillis() + (1000 * crownTime));
				
				kingdom.sendMessage(crownTime);
			}
