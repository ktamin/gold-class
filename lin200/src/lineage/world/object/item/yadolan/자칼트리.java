...
public class 자칼트리 extends ItemInstance {
	...
	public void toClick(Character cha, ClientBasePacket cbp) {
			...
			if (cha.getInventory() != null) {
				...
				if (SkillController.find(cha, 115, false) != null ) {
					...
					if (SkillController.isHpMpCheck(cha, s.getHpConsume(), s.getMpConsume()) && Util.isDistance(pc, pc.autoAttackTarget, 8) && pc.autoAttackTarget != null ) {
						if (SkillController.isDelay(cha, SkillDatabase.find(115)))
							TripleArrow.init(pc, s, (int) pc.autoAttackTarget.getObjectId(), pc.autoAttackTarget.getX(), pc.autoAttackTarget.getY());
					}
				} 
			}
	}
