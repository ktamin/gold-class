...
public class 반지변경주문서 extends ItemInstance {
    ...
    public void toClick(Character cha, ClientBasePacket cbp) {
        ...
        if (src == null || !(src instanceof ItemArmorInstance)) {
            ChattingController.toChatting(cha, "반지에 사용 가능합니다.", Lineage.CHATTING_MODE_MESSAGE);
            return;
        }
        if (src.getItem() == null) {
        ...
        if (containsIgnoreCase(GRADE1, srcName)) {
            ...
            ChattingController.toChatting(cha, "해당 반지에 사용할 수 없습니다.", Lineage.CHATTING_MODE_MESSAGE);
            return;
        }
