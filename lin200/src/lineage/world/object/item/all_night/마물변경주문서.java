...
public class 마물변경주문서 extends ItemInstance {
        ...
        if (cha.getInventory() != null) {
            ...
            if (item != null && item instanceof ItemArmorInstance) {
                ...
                for (String type : types) {
                    if (item.getItem().getName().startsWith("고대 마물의") && item.getItem().getName().contains(type)) {
                        String newName = item.getItem().getName().replace("고대 마물의", "고대 암석의").trim();
                ...
                ChattingController.toChatting(cha, "해당 아이템은 마물 계열만 사용할 수 있습니다.", Lineage.CHATTING_MODE_MESSAGE);
            } else {
