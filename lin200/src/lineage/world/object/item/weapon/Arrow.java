...
public class Arrow extends ItemInstance {
	...
	public void toClick(Character cha, ClientBasePacket cbp) {
		...
		if (equipped) {
			...
			//ChattingController.toChatting(cha, String.format("화살 무장 해제: %s", toStringDB()), Lineage.CHATTING_MODE_MESSAGE);
		} else {
			setEquipped(true);
			cha.getInventory().setSlot(Lineage.SLOT_ARROW, this);
			//ChattingController.toChatting(cha, String.format("화살 무장: %s", toStringDB()), Lineage.CHATTING_MODE_MESSAGE);
		}
