		...
		if (enabled) {
			// 1단계 마법인형
						if (mdl.getDollBuffType().equalsIgnoreCase("돌 골렘")) {
							...
							ChattingController.toChatting(pc, "아이리스: PvP 대미지+3, 대미지 감소+3", Lineage.CHATTING_MODE_MESSAGE);
							...
							pc.setDynamicReduction(pc.getDynamicReduction() + 3);
							ChattingController.toChatting(pc, "머미로드: 경험치 보너스+15%, 대미지 감소+3", Lineage.CHATTING_MODE_MESSAGE);
							// 5단계 마법인형
							...
							ChattingController.toChatting(pc, "안타라스: 스턴 내성+10, 대미지 감소+8, 경험치 보너스+35%, 64초당 MP 회복+20", Lineage.CHATTING_MODE_MESSAGE);
				...
				pc.setDynamicBowCritical(pc.getDynamicBowCritical() + 10);
				pc.setDynamicStunResist(pc.getDynamicStunResist() + 0.15);
				pc.setDynamicExp(pc.getDynamicExp() + 0.30);
				pc.setMagicdollTimeMpTic(64);
				pc.setMagicdollMpTic(15);
				ChattingController.toChatting(pc, "각성 린드비오르: 원거리 대미지+10, 원거리 명중+10, 원거리 치명타+10%, 스턴 내성+15, 64초당 MP 회복+15 , 경험치 보너스+30%", Lineage.CHATTING_MODE_MESSAGE);
				...
				pc.setDynamicMagicCritical(pc.getDynamicMagicCritical() + 7);
				pc.setDynamicStunResist(pc.getDynamicStunResist() + 0.15);
				pc.setDynamicExp(pc.getDynamicExp() + 0.30);
				pc.setMagicdollTimeMpTic(64);
				pc.setMagicdollMpTic(30);
				ChattingController.toChatting(pc, "각성 파푸리온: SP+6, 마법 명중+10, 마법 치명타+7%, 스턴 내성+15, 64초당 MP 회복+30 , 경험치 보너스+30%", Lineage.CHATTING_MODE_MESSAGE);
				...
				pc.setMagicdollTimeMpTic(64);
				pc.setMagicdollMpTic(20);
				ChattingController.toChatting(pc, "각성 안타라스: 스턴 내성+15, 대미지 감소+10, 경험치 보너스+50%, 64초당 MP 회복+20", Lineage.CHATTING_MODE_MESSAGE);
				...
				pc.setMagicdollTimeMpTic(64);
				pc.setMagicdollMpTic(5);
				ChattingController.toChatting(pc, "다크엘프: 근거리 대미지+2, 근거리 명중+4, 근거리 치명타+2%,  64초당 MP 회복+5, 경험치 보너스+10%", Lineage.CHATTING_MODE_MESSAGE);	
